            ...
            if( dis < 200 and userFound != True):
                ...
                while face_not_found:
                    ...
                    for face_encoding in face_encodings:
                        ...
                        match = face_recognition.compare_faces([self.preston_face_encoding,self.joseph_face_encoding], face_encoding)
                        name = "<Unknown Person>"
